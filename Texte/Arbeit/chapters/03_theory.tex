...
Crystal settling in magmatic systems typically occurs at very low Reynolds numbers, where viscous forces dominate over inertial effects (Quellen suchen!). In this creeping-flow regime, the governing equations reduce to the incompressible Stokes equations
\begin{equation}
...
\parencite{add_numerical_nodate,uhlmann_sedimentation_2014}.
...
inclusions and sedimentation (Stokes Buch organisieren). Streamlines
...
The U-Net \parencite{onneberger_u-net_2015} is an encoder--decoder convolutional neural
