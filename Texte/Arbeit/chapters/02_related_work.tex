...
solution fields \cite{navab_u-net_2015,thuerey_deep_2020}. Their success can be 
...
\cite{ribeiro_deepcfd_nodate,chen_u-net_nodate}. These results established deep 
...
global flow structures \cite{thuerey_deep_2020}. This combination of local and 
...
\cite{raissi_physics-informed_2019}. Rather than relying exclusively on paired 
...
together with the divergence-free constraint \cite{jin_nsfnets_2021}.
...
improve learning on irregular domains \cite{oldenburg_geometry_2022}. While 
...
Navier--Stokes turbulence \cite{li_fourier_2021}.
...
\cite{thuerey_deep_2020}. These properties make neural operators appealing
...
\cite{fortes_nonlinear_1987,ladd_numerical_1994,leonardi_coupled_2014}. These 
...
skip connections \cite{navab_u-net_2015}. A key advantage of this paradigm is
...
\cite{thuerey_deep_2020}. These properties make grid-based convolutional models
particularly attractive for multi-crystal sedimentation problems.

\subsection{Spectral Neural Operators}

Fourier Neural Operators \cite{li_fourier_2021} constitute an alternative
