...
kreisförmigen Kristallen auf einem festen $256 \times 256$-Gitter. Eine
systematische Hyperparameterstudie für Einkristall-Konfigurationen identifiziert
ein effektives U-Net-Trainingssetup mit einem relativen $L_2$-Fehler von
ca.~$2{,}1\,\%$ auf der Stromfunktion. Die Auswertung auf
Zweikristall-Konfigurationen zeigt einen systematischen Anstieg des mittleren
Fehlers auf ca.~$7{,}6\,\%$ bei gleichzeitig deutlich höherer Varianz, was auf
geometrieabhängige Vorhersageschwierigkeit durch hydrodynamische Wechselwirkungen
hinweist. Aus~$\psi$ abgeleitete Geschwindigkeitsfelder erweisen sich
