...
share the same input and output interface: a five-channel input tensor of
shape $(256,256,5)$—consisting of the crystal mask, a signed distance proxy
field, the distance to the nearest crystal boundary, and normalized $x$- and
$z$-coordinate channels—and a single-channel
...
($5 \to d_v$ channels), a stack of $L$ FNO blocks, and a two-layer pointwise
...
The U-Net uses the Adam optimizer. The FNO uses Adam combined
