...
min_crystals = 2      # minimum Anzahl Kristalle pro Sample
max_crystals = 2      # maximum Anzahl Kristalle pro Sample
...
# Datengenerierung
n_train   = 100                # nur benutzt, wenn mode == "generate_data"
outdir    = "/local/home/baselt/src/Daten/data_psi_vali"          # Ordner für .jld2-Samples
