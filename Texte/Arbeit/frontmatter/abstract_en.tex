...
the stream function $\psi$ from a four-channel geometric input encoding consisting
of a crystal mask, a signed distance field, and normalized spatial coordinates. Predicting $\psi$ rather
...
$1.6$--$2.5\%$ on~$\psi$, compared to $5.5$--$6.5\%$ for the U-Net, while
...
respectively), the FNO achieves in-distribution errors of $4$--$9\%$,
maintaining a roughly three- to four-fold advantage over the U-Net ($17$--$30\%$). OOD
...
degradation to $10.4\%$, demonstrating that the spectral limitation can be
overcome through training data diversity without architectural modifications.
