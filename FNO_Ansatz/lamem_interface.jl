...
export run_sinking_crystals  # <<< WICHTIG: .. statt .
...
function run_sinking_crystals(; nx::Int=256, nz::Int=256,
                               ...
                               out_file_name::String="FS_vel_gradient")
    ...
    x_vec_1D = data.x.val[:, 1, 1]     # km
    z_vec_1D = data.z.val[1, 1, :]     # km
    ...
    dx = (x_vec_1D[2] - x_vec_1D[1]) * 1000.0  # km -> m
    dz = (z_vec_1D[2] - z_vec_1D[1]) * 1000.0  # km -> m
