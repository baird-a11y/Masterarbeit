...
\cite{happel_low_1991,stokes_mathematical_2009}. In this creeping-flow regime,
...
\cite{fortes_nonlinear_1987,ladd_numerical_1994,uhlmann_sedimentation_2014}.
...
\cite{martin_crystal_1988,weinstein_evolution_1988,martin_fluid-dynamical_1989}.
...
inclusions and sedimentation \cite{stokes_mathematical_2009}. Streamlines
...
the space of functions that the model can represent \cite{belkin_reconciling_2019}.
...
\cite{ribeiro_deepcfd_nodate,chen_u-net_nodate,thuerey_deep_2020}, it can lead to
...
structure-preserving learning \cite{richter-powell_neural_nodate}. By reducing
...
surrogate models \cite{sun_surrogate_2020}.
...
The U-Net \cite{navab_u-net_2015} is an encoder--decoder convolutional neural
...
The Fourier Neural Operator (FNO) \cite{li_fourier_2021} belongs to the family
