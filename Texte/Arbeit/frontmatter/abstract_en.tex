...
$256 \times 256$ grid. A systematic hyperparameter study for single-crystal
configurations identifies an effective U-Net training setup achieving a relative
$L_2$ error of approximately $2.1\,\%$ on the stream function. Evaluation on
two-crystal configurations reveals a systematic increase in mean error to
approximately $7.6\,\%$, accompanied by substantially higher variance, indicating
that hydrodynamic interaction complexity introduces geometry-dependent prediction
difficulty. Gradient-derived velocity quantities prove consistently harder to
